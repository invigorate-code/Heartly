...
export const signInUser = async (formFields: SignInUserFormFields): Promise<SignInUserResponse> => {
  return new Promise((resolve, reject) => {
      api
...
export const signUpUser = async (formFields: SignUpUserFormFields): Promise<any> => {
  return new Promise((resolve, reject) => {
    api
