...
const NAV_ITEMS: NavItem[] = [
  {
    ...
    allowedRoles: ["OWNER", "ADMIN", "STAFF"], // All roles can see dashboard
  },
  {
    ...
    allowedRoles: ["OWNER", "ADMIN", "STAFF"], // All roles can view clients
  },
  {
    ...
    allowedRoles: ["OWNER", "ADMIN"], // Only OWNER and ADMIN can manage facilities
  },
  {
    ...
    allowedRoles: ["OWNER", "ADMIN"], // Analytics for OWNER and ADMIN only
  },
  {
    ...
    allowedRoles: ["OWNER", "ADMIN", "STAFF"], // All roles can access settings
  },
];
