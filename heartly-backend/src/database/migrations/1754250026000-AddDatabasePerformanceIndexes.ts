...
export class AddDatabasePerformanceIndexes1754250026000 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX IF EXISTS "IDX_user_created_performance"`);
    
    await queryRunner.query(`DROP INDEX IF EXISTS "IDX_audit_log_tenant_performance"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "IDX_audit_log_facility_performance"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "IDX_audit_log_user_performance"`);
    
    await queryRunner.query(`DROP INDEX IF EXISTS "IDX_facility_staff_performance_user"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "IDX_facility_staff_performance_facility"`);
    
    await queryRunner.query(`DROP INDEX IF EXISTS "IDX_user_onboarding_performance"`);
